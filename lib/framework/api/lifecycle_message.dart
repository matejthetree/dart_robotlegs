...
class LifecycleMessage {
  ...
  static const Symbol STATE_CHANGE =
      const Symbol("LifecycleMessage.stateChange");

  static const Symbol PRE_INITIALIZE =
      const Symbol("LifecycleMessage.preInitialize");

  static const Symbol INITIALIZE = const Symbol("LifecycleMessage.initialize");

  static const Symbol POST_INITIALIZE =
      const Symbol("LifecycleMessage.postInitialize");
  ...
  static const Symbol POST_SUSPEND =
      const Symbol("LifecycleMessage.postSuspend");
  ...
  static const Symbol POST_DESTROY =
      const Symbol("LifecycleMessage.postDestroy");
}
