...
class MediatorViewHandler {
  ...
  void addMapping(IMediatorMapping mapping) {
    if (!_mappings.contains(mapping)) _mappings.add(mapping);
    _flushCache();
  }

  void removeMapping(IMediatorMapping mapping) {
    if (!_mappings.contains(mapping)) return;
