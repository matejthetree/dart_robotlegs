...
class CommandExecutor implements ICommandExecutor {
  ...
  CommandExecutor(this._injector,
      [this._removeMapping = null, this._handleResult = null]);
  ...
  void executeCommand(ICommandMapping mapping,
  ...
  void executeCommands(List<ICommandMapping> mappings,
      [CommandPayload payload = null]) {
