...
class TypeFilter implements ITypeFilter {
  ...
  String get descriptor =>
      _descriptor != null ? _descriptor : _createDescriptor();
  ...
  bool matches(dynamic item) {
    ...
    if (_anyOfTypes.length == 0 &&
        (_allOfTypes.length > 0 || _noneOfTypes.length > 0)) {
      return true;
    }
  ...
  String _createDescriptor() {
    final List<String> allOf_FCQNs =
        _alphabetiseCaseInsensitiveFCQNs(allOfTypes);
    final List<String> anyOf_FCQNs =
        _alphabetiseCaseInsensitiveFCQNs(anyOfTypes);
    final List<String> noneOf_FCQNs =
        _alphabetiseCaseInsensitiveFCQNs(noneOfTypes);
