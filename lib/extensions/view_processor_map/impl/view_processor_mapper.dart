...
class ViewProcessorMapper
    implements IViewProcessorMapper, IViewProcessorUnmapper {
  //-----------------------------------
  //
  // Private Properties
  //
  ...
  void fromProcess(dynamic processorClassOrInstance) {
    ...
    if (mapping != null) _deleteMapping(mapping);
  }
  ...
  ViewProcessorMapping _createMapping(dynamic processor) {
    final ViewProcessorMapping mapping =
        new ViewProcessorMapping(_matcher, processor);
  ...
  IViewProcessorMappingConfig _overwriteMapping(
      IViewProcessorMapping mapping, dynamic processClassOrInstance) {
    if (_logger != null)
      _logger.warn(
